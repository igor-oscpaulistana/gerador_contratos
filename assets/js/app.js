const steps = ["Empresa","Sócios","Capital","Objeto Social","Administração","Revisão"];
  ...
  function contractHtml(d){
    ...
    const initial=currentUserInitial();
    ...
    return `
      <div class="contract-document constitution-document">
          ...
          <div class="sheet-inner">
            ...
            <div class="sheet-body">
              ...
              <table class="quota-table">
                <thead>
                  <tr><th>SÓCIO</th><th>QUOTAS</th><th>%</th><th>VALOR</th></tr>
                </thead>
                <tbody>
                  ${capitalRows}
                  <tr class="total-row">
        ...
        <section class="contract-sheet">
          <div class="sheet-inner">
            ${header()}
            <div class="sheet-body">
              <div class="clause-title first-clause">CLÁUSULA QUARTA - DO OBJETO SOCIAL</div>
        ...
        <section class="contract-sheet">
          <div class="sheet-inner">
            ${header()}
            <div class="sheet-body">
              <div class="clause-title first-clause">CLÁUSULA DÉCIMA – DO EXERCÍCIO SOCIAL</div>
        ...
        <section class="contract-sheet">
          <div class="sheet-inner">
            ${header()}
            <div class="sheet-body">
              <div class="clause-title first-clause">CLÁUSULA DÉCIMA QUINTA - DO FORO</div>
  ...
  function downloadWordFromData(data){
    const wordCss = `
      ...
      .contract-document{width:auto;margin:0;padding:0}
      .contract-sheet{page-break-after:always;position:relative;min-height:700pt}
      .contract-sheet:last-child{page-break-after:auto}
      .sheet-inner{position:relative;min-height:700pt}
      .sheet-header .logos{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:18pt}
      .sheet-header .logo-img.souza{width:165pt;height:65pt}
      .sheet-header .logo-img.paulistana{width:136pt;height:65pt}
      .sheet-footer{margin-top:18pt}
      .sheet-footer-line{border-top:2pt solid #6b1b1b;margin-bottom:5pt}
      .sheet-page-number{text-align:right;font-size:8pt}
